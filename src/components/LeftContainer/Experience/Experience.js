...
const EXPERIENCE_ARRAY = [
  ...
  },
  {
    ...
    description:
      "Настройка и видение таргетированной рекламы, контекстной рекламы, медийной рекламы. Разработка воронок продаж, чат-ботов, стратегии. Сборка сайтов, квизов на конструкторе. Работа в графических программах для создания креативов. Создание и отправка ежедневного отчета. Коммуникация с клиентом и закрытие на продажу ",
  },
];
